...
class Domain:
    def __init__(self, x_min, x_max, y_min, y_max, r_minor, r_major, plasma_dim_x, plasma_dim_y, step_length, n_mesh_0, Te_mesh_0, Ti_mesh_0, n0):
        ...
        self.n_mesh = n_mesh_0
        self.Te_mesh = Te_mesh_0
        self.Ti_mesh = Ti_mesh_0
        self.n0 = n0
        ...
        self.electron_source_momentum_x = np.zeros_like(self.electron_source_particle)
        self.electron_source_momentum_y = np.zeros_like(self.electron_source_particle)
        self.electron_source_energy = np.zeros_like(self.electron_source_particle)
        self.ion_source_particle = np.zeros_like(self.electron_source_particle)
    ...
    def set_sources_zero(self):
        ...
        self.electron_source_momentum_x.fill(0)
        self.electron_source_momentum_y.fill(0)
        self.electron_source_energy.fill(0)
        self.ion_source_particle.fill(0)
